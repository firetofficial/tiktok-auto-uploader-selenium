...
if __name__ == "__main__":
    ...
    print(adminNoiti + Fore.WHITE + "Nhập caption cho video/Enter a caption for the video: ")
    caption = input()
    print(adminNoiti + Fore.WHITE + "Thời gian chờ (phút)/Waiting time (minutes): ")
    wait_time = float(input())
    print(adminNoiti + Fore.WHITE + "Số tài khoản chạy cùng lúc/Number of accounts running at the same time:: ")
    len_count = int(input())
    ...
    while True:
        ...
        if check_null and check_len:
            ...
            print(adminNoiti + Fore.WHITE + "Đã sử dụng hết cookie, chương trình dừng hoạt động/Once all the cookies have been used, the program stops working")
            break
